...
{
    [BenchmarkDotNet.Attributes.Columns.RankColumn, MemoryDiagnoser]
    public class ServiceBenchmark
    {
       // private const int Iterations = 1000;
       // private const int ComplexCollectionsSize = 1000;
        ...
        public async Task ComplexRest()
        {
            for (var i = 0; i < 1000; ++i)
            {
                ...
                {
                    Name = "World",
                    SimpleHellos = Enumerable.Range(0, 1000)
                        .Select(i => new JsonHelloRequest {Name = "World " + i}),
                    SomeRandomNumbers = Enumerable.Range(0, 1000)
                };
        ...
        public async Task ComplexGrpc()
        {
            for (var i = 0; i < 1000; ++i)
            {
                ...
                request.SomeRandomNumbers.AddRange(Enumerable.Range(0, 1000));
